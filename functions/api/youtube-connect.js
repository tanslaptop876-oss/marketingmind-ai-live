...
export async function onRequestGet(context){
  const configured=Boolean(context.env.GOOGLE_CLIENT_ID&&context.env.GOOGLE_CLIENT_SECRET&&context.env.YOUTUBE_REDIRECT_URI&&context.env.PROVIDER_TOKEN_ENCRYPTION_KEY),enabled=context.env.YOUTUBE_CONNECT_ENABLED==='true';
